...
public class WordManagerTrap : MonoBehaviour
{
    ...
    private int incorrectInputCounter;
    private int level = 1;
    ...
    IEnumerator WordCheck()
    {
        ...
        for (int i = 0; i < wordToChar.Count; i++)
        {
            ...
            if (!objectExpired)
            {
...

                {
                    ...
                    AudioManager.instance.PlaySound(AudioManager.instance.audioClips.ShotgunShoot);
                ...
                {
                    AudioManager.instance.PlaySound(AudioManager.instance.audioClips.LetterWrong);
                    AudioManager.instance.PlaySound(AudioManager.instance.audioClips.BulletMiss);
        ...
        AudioManager.instance.PlaySound(AudioManager.instance.audioClips.ShotgunReload);
    ...
    {
        AudioManager.instance.PlaySound(AudioManager.instance.audioClips.WordShoot);
        GameObject wordObject = ObjectPool.instance.GetPooledObject();
        Rigidbody rb = wordObject.GetComponent<Rigidbody>();
        wordObject.transform.position = spawnLocation.transform.position + new Vector3(Random.Range(-2.5f, 2.5f), 0, 0);
        ...
        rb.AddForce(spawnLocation.transform.forward * shotSpeed);
